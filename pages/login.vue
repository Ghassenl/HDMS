    ...
    <div class="logincard">
      <div class="login">
        <div class="text-center mb-5">
          ...
          <a class="nuxt-link" href="/signup">Sign-up</a>
      ...
      <div>
        <form @submit="onSubmit">
          ...
          <InputText id="email" v-model="email" type="text" :class="['w-full mb-3', { 'p-invalid': emailErrorMessage }]"
          ...
          <Password id="password" v-model="password" type="text" inputClass="w-full" :feedback="false" toggleMask
            :class="['w-full mb-3', { 'p-invalid': passwordErrorMessage }]" aria-describedby="password-text-error" />
